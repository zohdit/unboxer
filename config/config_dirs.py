...
IMDB_INPUTS = 'in/data/imdb_inputs'
...
FEATUREMAPS_META = 'logs/imdb/original/featuremaps_meta'
FEATUREMAPS_DATA_RAW = 'logs/imdb/original/featuremaps_data_raw'
FEATUREMAPS_DATA = 'logs/imdb/original/featuremaps_data'
...
# FEATUREMAPS_META = 'logs/mnist/original/featuremaps_meta'
# FEATUREMAPS_DATA_RAW = 'logs/mnist/original/featuremaps_data_raw'
# FEATUREMAPS_DATA = 'logs/mnist/original/featuremaps_data'